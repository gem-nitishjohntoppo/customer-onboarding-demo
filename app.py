...
# from text_processing import process_large_context_in_chunks, process_large_context
# import json
...
#         # if model_id == "meta.llama3-1-8b-instruct-v1:0":
#         #     final_json = process_large_context(context, schema, model_id='meta.llama3-1-8b-instruct-v1:0')
#         # else:
